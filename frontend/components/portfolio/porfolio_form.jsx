...
class PortfolioForm extends React.Component {
    ...
    handleSubmit(e) {
        ...
        this.props.addItem(this.state.user_id, item).then(
            (success) => {
    ...
    handleInput(type) {
        return (e) => {
            this.setState({ [type]: Math.round(e.target.value) });
        };
    }
    ...
    render() {
        let shoes = isEmpty(this.props.shoes) ? [] : Object.values(this.props.shoes);
        return (
                ...
                <form id="portfolio-form" onSubmit={this.handleSubmit}>
                    ...
                    <label id="portfolio-input-size">
                        <select defaultValue="" id="portfolio-form-size-sex-dropdown">
                            ...
                            <option value="M " key="sex-opt-M">
                                M
                            </option>
                            <option value="F " key="sex-opt-F">
                                F
                            </option>
                            <option value="K " key="sex-opt-K">
                                K
                            </option>
                        </select>
                        ...
                        <select defaultValue="" id="portfolio-form-size-num-dropdown">
                            ...
                            {sizes.map((size) => (
                                <option value={size} key={`size-opt-${size}`}>
                                {size}
                                </option>
                            ))}
                        </select>
                    ...
                    <label>
                        <input
                            ...
                            min="0"
                            step="1"
                            id="portfolio-form-price"
                            placeholder="Purchase Price"
                            onChange={this.handleInput("purchase_price")}
                        />
                    </label>
